...
- **4 Visual Themes:** Classic, Catppuccin (with all four flavours — Latte, Frappé, Macchiato, Mocha), Stained Glass and Origami. Every theme shares one behaviour core, so only the look differs.
