...
AGENT_SHORT = {"claude-code": "CC", "codex": "Codex", "antigravity": "AGY"}
...
def _fmt_tokens(n: int) -> str:
    # 門檻要落在**四捨五入後**會進位的那個點，不是整數單位本身：999_950 除以
    # 1_000 是 999.95，用 .1f 印出來就是 "1000.0K"——一個永遠不會出現的單位。
    # 十億那一級同理，.2f 的進位點在 999_950_000。
    if n >= 999_950_000:
