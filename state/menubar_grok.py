...
"""Background-safe Grok CLI quota projection for the Windows tray panel."""
...
from i18n import _t
from providers.grok_quota_probe import GrokQuotaResult, find_grok, load_quota
from state.menubar_state import (
    GROK_COLOR,
    GrokStaleState,
    QuotaRowState,
    _bar_color,
