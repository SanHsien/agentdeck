    ...
    def _update_channel(
        ...
        if depleted:
            ...
            if crossed:
                ...
                # observation already past the highest one, or a single large
                # jump when multiple custom thresholds are configured. Warn on
                # the highest and latch the rest so one reading sends one
                # notification.
